  ...
  <style>
    ...
    * {{
    ...
    .thanks-card {{
      ...
      gap: 0.6rem;
      background: var(--bg-surface-elevated);
      border: 1px solid rgba(226, 173, 189, 0.3);
    ...
    .thanks-card:hover {{
      ...
      background: rgba(226, 173, 189, 0.08);
      transform: translateY(-1px);
    }}
      ...
      <footer class="doc-footer">
        ...
        <div>
          <div class="thanks-card">
            <span>با تشکر از</span>
            <a href="https://www.youtube.com/@iampedi" target="_blank" rel="noopener" title="iampedi">iampedi ↗</a>
            <span>برای ویدیوی خوبش درباره‌ی این ابزار</span>
          </div>
        </div>
      </footer>
